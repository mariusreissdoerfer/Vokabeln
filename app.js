const vocabulary = [
  ...
  { en: "Clause",        de: "Klausel" },
  { en: "Subjects",      de: "Themen / Gegenstände" },
  { en: "Avoid",         de: "vermeiden" },
  { en: "Chasing",       de: "nachverfolgen / hinterherlaufen" },
  { en: "So far",        de: "bisher" },
  { en: "Relate",        de: "beziehen auf" },
  { en: "Behavior",      de: "Verhalten" },
  { en: "Suppose",       de: "annehmen" },
  { en: "Propose",       de: "vorschlagen" },
  { en: "According",     de: "gemäß / entsprechend" },
  { en: "Recently",      de: "kürzlich" },
  { en: "Conduct",       de: "durchführen / Verhalten" },
  { en: "Assume",        de: "annehmen" },
  { en: "Postpone",      de: "verschieben" },
  { en: "Required",      de: "erforderlich" },
  { en: "Tendering",     de: "Ausschreibung / Vergabeverfahren" },
  { en: "Expect",        de: "erwarten" },
  { en: "Scope",         de: "Umfang" },
  { en: "At least",      de: "mindestens" },
  { en: "Negotiate",     de: "verhandeln" },
  { en: "Regarding",     de: "bezüglich" },
  { en: "Might / Could", de: "könnte / könnten" },
  { en: "Investigate",   de: "untersuchen" },
  { en: "Ensure",        de: "sicherstellen" },
];
